...
while carryOn:   
    ...
    t2 = time.time()
    # TA2- Step 3: Evaluate elapsed time t2-t1 and assign it to variable "game_time" and print "game_time" rounded off to 2 decimal places
    game_time = t2-t1
    game_time = round(game_time, 2)
    print("Elapsed time is:",game_time, "seconds")
